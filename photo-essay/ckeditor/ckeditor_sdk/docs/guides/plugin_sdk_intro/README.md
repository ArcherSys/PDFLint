...
Learning by example is always the best idea, so check our **plugin tutorials** that will show you how to create some basic plugins.
 ...
 1. **Live Demos** &ndash; See the **working demos** of the custom [Timestamp](../samples/timestamp.html) and [Abbreviation](http://sdk.ckeditor.com/samples/abbr.html) plugins created in the tutorials live in action in CKEditor SDK.
